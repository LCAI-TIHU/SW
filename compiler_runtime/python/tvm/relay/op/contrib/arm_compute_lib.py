...
from ...dataflow_pattern import is_constant, is_expr, is_op, is_var, wildcard
...
def arm_compute_lib_pattern_table():
    ...
    '''return [
        ("arm_compute_lib.conv2d", conv_pattern()),
        ("arm_compute_lib.qnn_conv2d", qnn_conv_pattern()),
        ("arm_compute_lib.dense", dense_pattern()),
        ("arm_compute_lib.qnn_dense", qnn_dense_pattern()),
        ("arm_compute_lib.qnn_conv2d", qnn_conv_pattern()),
        ("arm_compute_lib.avg_pool2d", avg_pool2d_pattern()),
        ("arm_compute_lib.l2_pool2d", l2_pool2d_pattern()),
    ]'''
