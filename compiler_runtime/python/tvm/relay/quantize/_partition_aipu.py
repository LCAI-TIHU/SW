...
from ._partition import QPartitionExpr
...
@register_aipu_partition_function("nn.conv2d")
...
def add_partition_generic(ref_call, new_args, ctx):
    ...
    if lhs_cond and rhs_cond:
        ...
        #     ...
        # lhs = new_args[0].realize() #Abraham
        # rhs = new_args[1].realize() #Abraham
...
# TODO(ziheng) enhance `register_aipu_partition_function` to dispatch
# for target automatically
@register_aipu_partition_function("add")
