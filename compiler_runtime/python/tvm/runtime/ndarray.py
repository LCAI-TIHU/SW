...
def numpyasarray(np_data):
    ...
    print("In python print the shape is:", shape)
    arr.data = data.ctypes.data_as(ctypes.c_void_p)
    arr.shape = shape
    print("In python print the arr.shape is: ", arr.shape[0], tvm_shape_index_t)
    print("In python print the data.shape is: ", data.shape)
    #print("In python print the data: ",data[0,26,10]) # shenfw add
    #print("In python print the data: ",(arr.data.contents))
