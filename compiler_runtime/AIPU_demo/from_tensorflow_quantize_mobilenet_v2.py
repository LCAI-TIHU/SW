...
model_path = "/workspace/tfmodel/mobilenet_v2_1.0_224_frozen.pb"
layout = "NHWC"
label_offset = 1
output_number = 1001
batch_size = 1
...
def quantize(mod, params, target, data_aware, do_simulation):
    if data_aware:
        with relay.quantize.qconfig(target=target, calibrate_mode="kl_divergence", weight_scale="channel_max", skip_conv_layers=[], do_simulation=do_simulation): #, dtype_input="uint8", debug_enabled_ops=["nn.conv2d"], calibrate_chunk_by=16
