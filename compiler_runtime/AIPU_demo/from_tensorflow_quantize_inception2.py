...
model_path = "/workspace/tfmodel/inception_v3_frozen-with_shapes.pb"
layout = "NHWC"
label_offset = 1
output_number = 1001
batch_size = 1
...
def create_graph(model_path):
    ...
    with tf_compat_v1.gfile.GFile(model_path, "rb") as f:
        ...
        with tf_compat_v1.Session() as sess:
            graph_def = tf_testing.AddShapesToGraphDef(sess, "InceptionV3/Predictions/Softmax") # MobilenetV2/Predictions/Softmax
...
def run_test(lib, origin_shape=None):
    image = cv2.imread("/workspace/imagenet/val/ILSVRC2012_val_00000008.JPEG")
