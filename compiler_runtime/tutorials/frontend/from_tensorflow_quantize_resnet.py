...
repo_base = "https://hub.fastgit.org/dmlc/web-data/raw/main/tensorflow/models/InceptionV1/"
model_base = "https://hub.fastgit.org/dmlc/web-data/raw/main/tensorflow/models/ResnetV2/"
...
model_url = os.path.join(model_base, model_name)
...
model_path = download_testdata(model_url, model_name, module=["tf", "ResnetV2"])
