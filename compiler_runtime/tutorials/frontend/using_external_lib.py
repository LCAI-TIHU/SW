...
print("before runtime.GraphModule")
##print(type(lib))
##print(type(lib["default"])) # "default" is one of the key(only one for string) of the lib, and call the get function
##print(lib["default"])
##print(type(lib["default"](dev)))
#module = runtime.GraphModule(lib["default"](dev)) # eventuall call the function Init()
