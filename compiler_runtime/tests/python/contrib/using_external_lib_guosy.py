...
data = relay.var("data", relay.TensorType((batch_size, 224, 224, 3), "float32"))
...
simple_net = relay.nn.conv2d(
    data=data, weight=weight, kernel_size=(3, 3),data_layout="NHWC",
        kernel_layout="HWIO", channels=out_channels, padding=(1, 1)
)
#simple_net = relay.nn.batch_norm(simple_net, bn_gamma, bn_beta, bn_mmean, bn_mvar)[0]
simple_net = relay.nn.relu(simple_net)
simple_net = relay.Function(relay.analysis.free_vars(simple_net), simple_net)
mod=tvm.IRModule.from_expr(simple_net)
mod["main"] = set_external_func_attr(mod["main"],"aipu","aipu1")
