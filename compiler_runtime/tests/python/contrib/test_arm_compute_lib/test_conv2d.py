...
def _get_model(
    ...
    # print("a shape:",shape,"dtype:",type)
    ...
    # print("w shape:",weight_shape,"w dtype:",dtype)
    weights = relay.const(w, dtype)
    # weights = relay.var("weight",relay.TensorType(weight_shape,"float32"))
    out = relay.nn.conv2d(
        a,
        weights,
    ...
    # print("a",a)
    params = {"w": w}
    # print("get model:",has_bias,has_activation)
    if has_bias:
    ...
    out = relay.nn.relu(out)
    out = relay.multiply(out,relay.const(2,"float32"))
    out = relay.nn.conv2d(
        out,
        weights,
        kernel_size=(kernel_h, kernel_w),
    ...
    data = relay.var("data", relay.TensorType((1, 224, 224, 3), "float32"))
    ...
    # )
    simple_net = relay.nn.conv2d(
        data=data, weight=weight, kernel_size=(3, 3),data_layout="NHWC",
            kernel_layout="HWIO", channels=16, padding=(1, 1)
    )
    #simple_net = relay.nn.batch_norm(simple_net, bn_gamma, bn_beta, bn_mmean, bn_mvar)[0]
    simple_net = relay.nn.relu(simple_net)
    params={}
    return simple_net, params
...
def test_conv2d():
    ...
    trials = [
        # Normal convolution
        [2, 2, (1, 1), (1, 1), (1, 1), 4, (10, 10, 14), (False, False, True), False],
    ...
    for (
        ...
        # print("shape:",shape,"composite:",composite)
...
def test_codegen_conv2d():
    ...
    trials = [
        # Normal convolution
        [2, 2, (1, 1), (1, 1), (1, 1), 4, (10, 10, 4), (False, False, False), False],
        [2, 1, (2, 2), (1, 1), (1, 1), 7, (12, 15, 16), (False, False, True), False],
        [3, 3, (2, 1), (1, 1), (1, 1), 4, (10, 10, 14), (False, True, False), False],
        [3, 3, (1, 1), (1, 1), (1, 1), 16, (12, 15, 16), (False, False, False), False],
        [5, 5, (1, 1), (2, 2), (1, 1), 4, (10, 10, 14), (True, False, False), False],
