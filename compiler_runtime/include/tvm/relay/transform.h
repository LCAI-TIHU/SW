...
TVM_DLL Pass MergeComposite(const tvm::Array<runtime::String>& pattern_names,
...
TVM_DLL Pass AnnotateTarget(const Array<runtime::String>& targets, bool include_non_call_ops);
/*!
...
TVM_DLL Pass MergeCompilerRegions();
